...
\section[Super-resolution impact on interpretation]{SR impact on interpretation}
...
\section[Super-resolution model construction]{SR model construction}
...
\Cref{ch:paper1} was prepared prior the release of a large and varied synthetic geology training dataset \parencite{jessellNoddyverseMassiveData2022}.
...
Coordinate MLPs for implicit representation are a currently burgeoning field of research in computer science, and we identify opportunities in extending advances in this research to future applications in geophysics, as outlined in \Cref{ch:futurework}.
