...
\begin{titlepage}
    ...
    \begin{center}
        ...
        \begin{figure}[h]
            \centering{}
            \includegraphics[scale=0.5]{fig/etc/UWA_FORMAL_PORTRAIT_CMYK}
        \end{figure}
...
\newpage{}
% \subfile{authorship_declaration}
\includepdf[pages=-]{authorship_declaration_signed.pdf}
...
\label{paper3}
% \includepdf[pages=-]{paper3.pdf}
% \subfile{paper3}
\include{paper3}

% \includepdf[pages=-]{discussion.pdf}
% \subfile{discussion}
\include{discussion}
