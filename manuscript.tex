...
The data-driven approach can extract high-resolution grids from the learned representation, as well as calculate the analytical spatial gradients.
...
However, in combination, and together they reflect ongoing advances in deep learning and their extension to challenges and opportunities in geophysics.

\newpage{}
\addsec{Acknowledgements}

I wish to thank a great number of people who have contributed to my ongoing development.
...
Andie, Dale, and Robert, and the rest of my family in NSW --- I didn't get to visit as much as I had originally planned in 2019, but we made the most of it! Thanks for the support and encouragement, and imparting all the passions of rocks, computers, and tinkering that I have today.
...
My first floor colleagues and fellow tech geeks, Daniel, David, Chris, Minh, and Peter --- Your friendship and knowledge has been a wonderful environment to grow as a geodata scientist in.
