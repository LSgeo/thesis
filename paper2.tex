...
Similar structural inaccuracies are seen in\Cref{fig:srdata17}, where severe aliasing again fails to be corrected using the baseline model, but is resolved by fine-tuning.
