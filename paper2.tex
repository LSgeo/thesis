...
Local texture estimator (LTE) \parencite{leeLocalTextureEstimator2022} is implemented in this work for its performance in the task of image super-resolution.
...
In addition FSIM \parencite{linzhangFSIMFeatureSimilarity2011} is used to quantify the quality of the super-resolved image.
...
Model performance is quantified using FSIM in \Cref{tab:2metrics}.
