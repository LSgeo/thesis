...
\begin{figure}[hbt]
    \includegraphics[width=\textwidth]{fig/p2/srcomp_23.pdf}
...
\begin{figure}[hbt]
    \includegraphics[width=\textwidth]{fig/p2/srcomp_14.pdf}
    \caption[Super-resolution geophysics grid results]{Super-resolution predictions on open access data, prepared using the proposed method.
        Explanation in-text.
        Grid A is the super-resolution prediction using the baseline model, while grid B is the SR prediction using the fine-tuned model.}
    \label{fig:srdata14}
...
\begin{figure}[hbt]
    \includegraphics[width=\textwidth]{fig/p2/srcomp_17.pdf}
    \caption[Super-resolution geophysics grid results]{Super-resolution predictions on open access data, prepared using the proposed method.
        Explanation in-text.
        Grid A is the super-resolution prediction using the baseline model, while grid B is the SR prediction using the fine-tuned model.}
    \label{fig:srdata17}
...
\begin{figure}[hbt]
    \includegraphics[width=\textwidth]{fig/p2/srcomp_18.pdf}
    \caption[Super-resolution geophysics grid results]{Super-resolution predictions on open access data, prepared using the proposed method.
        Explanation in-text.
        Grid A is the super-resolution prediction using the baseline model, while grid B is the SR prediction using the fine-tuned model.}
    \label{fig:srdata18}
