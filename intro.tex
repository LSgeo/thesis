...
The field strength measured is the total magnetic intensity (TMI), which is the magnitude of vector potential \parencite{blakelyPotentialTheoryGravity1996}, recorded in nanotesla (nT).
It is useful in exploration geophysics to communicate the magnetic anomaly, which is the residual between the International Geomagnetic Reference Field (IGRF) model of the Earth's magnetic field, and the measured TMI at the location.
Magnetic anomaly may be negative, and can exceed several thousand nanotesla in the Earth's environment.
