...
The above aims are achieved using case studies with open access aeromagnetic data provided by Geoscience Australia.
...
This is performed by back propogation \parencite{rumelhartLearningRepresentationsBackpropagating1988}, a technique to navigate toward the lowest error solution by calculating the rate of improvement resulting from parameter updates.
...
The other primary descriptor of a neural network is its architecture, refering to the configuration of its intermediate layers between the input and output.
...
The current generation of deep learning is reported in review articles to have begun in 2006 \parencite{dengDeepLearningMethods2014,goodfellowDeepLearning2016a}, and has pervaded many industries and research fields.
