...
The sinusoidal activation of \parencite{sitzmann2019siren} is used. % for a baseline, and comparison is made to Gaussian and wavelet activations.
...
It does not use the Laplace loss discussed above. %, summed with weighted Laplace's equation loss, \cref{eqn:cri}.
\begin{equation}
    \label{eqn:cri}
...
\begin{figure}[hbt]
    \centering{}
    \includegraphics[width=1.\linewidth]{fig/p3/grid_comparison.pdf}
...
\begin{figure}[hbt]
    ...
    \includegraphics[width=1.\linewidth]{fig/p3/grid_comparison_35m.pdf}
...
\begin{figure}[hbt]
    \centering
    \includegraphics[width=1.\linewidth]{fig/p3/dh_comparison.pdf}
...
\begin{figure}[hbt]
    \centering
    \includegraphics[width=1.\linewidth]{fig/p3/dv_comparison.pdf}
